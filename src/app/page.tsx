...
<AuroraBackground> 
      ...
      <div className="absolute top-0 right-0 !mt-4 !mr-3 pointer-events-auto"><UserButton afterSignOutUrl="/" /></div>
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mr-3 text-5xl font-semibold !p-2 relative z-10">Chat with any PDF</h1>
      </PointerHighlight>
        </div>
